...
export default function VehicleMaster() {
  ...
  const onHandleSearch = (event) => {
    ...
    if (searchText !== "") {
      apiClient
        .get(`/Jack?searchText=${searchText}&page=0`)
        .then((response) => {
  ...
  const fetchMoreData = () => {
    if (searchText === "") {
      ...
      const page = openPage + 1;
      apiClient
        .get(`/Jack?searchText=${searchText}&page=${page}`)
        .then((response) => {
            ...
            >
              {(filteredCard.length === 0 ? card : filteredCard).map((item) => (
                <CardComponent
                  ...
                  description={item.Status === "1" ? "ACTIVE" : "INACTIVE"}
                  onClick={() => {
                ...
                <Grid container>
                  ...
                  <Grid item md={6} xs={12} textAlign={"center"}>
                    <Controller
                      ...
                      control={control}
                      rules={{
                        required: "Jack Name  is Required",
                      }}
                      render={({ field, fieldState: { error } }) => (
                        <InputTextField
                          label="JACK NAME"
                  ...
                  <Grid item md={6} xs={12} textAlign={"center"}>
                    <Controller
                      name="JackType"
                      rules={{
                        required: "Please Select Jack Type",
                      }}
                      control={control}
                      render={({ field, fieldState: { error } }) => (
                        <InputSelectTextField
