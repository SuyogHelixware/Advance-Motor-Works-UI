...
//         .request({
//           method: "get",
//           url: `${BASE_URL}/Jack/search/${searchText}/0`,
//           headers: {
...
//   const getJackDataList = () => {
//     axios
//       .request({
//         method: "get",
//         url: `${BASE_URL}/Jack/pages/0`,
//         headers: {
//           "Content-Type": "application/json",
//         },
//       })
...
//   const setJackDataList = (DocEntry) => {
//     if (!DocEntry) {
//       return;
//     }
//     axios
//       .get(`${BASE_URL}/Jack/${DocEntry}`)
//       .then((response) => {
//         toggleDrawer();
...
//         .request({
//           method: "get",
//           url: `${BASE_URL}/Jack/search/${searchText}/${page}`,
//           headers: {
//             "Content-Type": "application/json",
//           },
//         })
...
//       JackName: data.JackName,
//       VehicleModeId: data.VehicleModeId,
//       JackType: data.JackType,
//       Remark: data.Remark || "",
...
//     {
//       Swal.fire({
//         text: `Do You Want Update "${Jack.JackName}"`,
//         icon: "question",
...
//           axios
//             .put(`${BASE_URL}/Jack/${DocEntry}`, Jack)
//             .then((response) => {
...
//         axios.delete(`${BASE_URL}/Jack/${DocEntry}`).then((resp) => {
//           if (resp.data.success) {
//             clearFormData();
//             getJackDataList();
//             setLoading(false);
