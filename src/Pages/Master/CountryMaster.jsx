...
//         .request({
//           method: "get",
//           url: `${BASE_URL}/Country/search/${searchText}/0`,
//           headers: {
...
//   const setCountryDataList = (DocEntry) => {
//     if (!DocEntry) {
//       return;
//     }
//     axios
//       .get(`${BASE_URL}/Country/${DocEntry}`)
//       .then((response) => {
//         toggleDrawer();
...
//         .request({
//           method: "get",
//           url: `${BASE_URL}/Country/pages/${page}`,
//           headers: {
//             "Content-Type": "application/json",
//           },
//         })
...
//         .request({
//           method: "get",
//           url: `${BASE_URL}/Country/search/${searchText}/${page}`,
//           headers: {
//             "Content-Type": "application/json",
//           },
//         })
...
//       DfltTaxCode: String(data.DfltTaxCode),
...
//     } else {
//       Swal.fire({
//         text: `Do You Want Update "${initial.DfltTaxCode}"`,
//         icon: "question",
...
//           axios
//             .put(`${BASE_URL}/Vehicle/${DocEntry}`, Country)
//             .then((response) => {
...
//     Swal.fire({
//       text: `Do You Want Delete "${initial.DfltTaxCode}"`,
//       icon: "question",
//       confirmButtonText: "YES",
//       cancelButtonText: "No",
//       showConfirmButton: true,
...
//         axios.delete(`${BASE_URL}/Country/${DocEntry}`).then((resp) => {
//           if (resp.data.success) {
//             clearFormData();
//             getCountryDataList();
//             setLoading(false);
...
//                   subtitle={item.TelCode}
//                   description={item.TaxPer}
//                   onClick={() => {
//                     setCountryDataList(item.DocEntry);
//                   }}
//                 />
//               ))}
//             </InfiniteScroll>
...
//                       control={control}
//                       rules={{
//                         required: "Country Name is required", // Field is required
//                       }}
...
//                       control={control}
//                       rules={{
//                         required: "Tel Code Name is required", // Field is required
//                       }}
//                       render={({ field, fieldState: { error } }) => (
//                         <InputTextField
//                           label="TEL CODE"
