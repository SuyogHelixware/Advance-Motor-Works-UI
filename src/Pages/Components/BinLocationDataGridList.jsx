    ...
    >
      ...
      >
        ...
        <Grid container>
            ...
            >
              <DataGrid
                ...
                getRowClassName={(params) => {
                  const isSelected =
                    (oLines || []).some(
                      (el) => (el.BinCode) === (params.row.BinCode)
                    );
          ...
          >
            <Button variant="contained" size="small" color="success" onClick={onSubmit}>
              Save
            </Button>
            <Button variant="contained"  size="small" color="error" onClick={closeModel}>
              Close
            </Button>
          </Grid>
        </Grid>
...
export default BinLocationDataGridList;
