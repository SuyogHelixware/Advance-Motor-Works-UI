...
export default function CashInvoice() {
  ...
  // bankData state for credit card table display
  const [bankData, setBankData] = useState([]);

  // FIX: addRow only clears credit card fields (not the whole form)
  // and also recalculates payment totals after adding
  const addRow = () => {
